...
import iuh.audioshop.modal.CartItem;
import iuh.audioshop.modal.Order;
import iuh.audioshop.modal.OrderDetail;
import iuh.audioshop.modal.Product;
import iuh.audioshop.modal.User;
import iuh.audioshop.repository.OrderDetailRepository;
import iuh.audioshop.repository.OrderRepository;
import iuh.audioshop.service.ShoppingCartService;
...
public class CartController extends CommomController {
    ...
    public String checkedOut(Model model, Order order, HttpServletRequest request, User user)
        ...
        commomDataService.sendSimpleEmail(user.getEmail(), "AudioShop Xác Nhận Đơn hàng", "aaaa", cartItems,
                totalPrice, order);
